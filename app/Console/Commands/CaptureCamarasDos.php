...
class CaptureCamarasDos extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'capture:dos';
     ...
     * @var string
     */
    protected $description = 'Comando para capturar la segunda parte de las pantallas de El Salvador';
    ...
    public function handle()
    {
        ...
        $pantallas = Pantalla::where('country_id',1)->select('name','link')->orderBy('id','ASC')->get();
